...
export class WooListImportController extends ListController {
    ...
    */
    async onClickWooProductImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_woo_import_product_instance", {});
    }
    ...
    */
    async onClickWooTaxImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_import_tax", {});
    }
    ...
    */
    async onClickWooUpdateQuantity() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_woo_import_inventory", {});
    }
    ...
    */
    async onClickWooProductCategoryImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_woo_import_product_category", {});
    }
    async onClickWooProductBrandImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_woo_import_product_brand", {});
    }
    ...
    */
    async onClickWooProductAttributeImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_woo_import_product_attribute", {});
    }
    ...
    */
    async onClickWooProductAttributeValueImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_woo_import_product_attribute_value", {});
    }
    ...
    */
    async onClickWooProductTagWooImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_import_product_tag", {});
    }
    ...
    */
    async onClickWooSaleOrderImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_import_sale_order", {});
    }
    ...
    */
    async onClickWooRefundImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_woo_import_refund_instance", {});
    }
    ...
    */
    async onClickWooCustomerImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_import_customer", {});
    }
    ...
    */
    async onClickWooCouponImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_woo_import_coupon_instance", {});
    }
    ...
    */
    async onClickWooShippingMethodImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_woo_import_shipping_method_instance", {});
    }
    ...
    */
    async onClickWooPaymentMethodImport() {
        return this.actionService.doAction("odoo_woo_commerce.action_wizard_woo_import_payment_gateway_instance", {});
    }
}
...
registry.category("views").add('woo_import_product_brand_button', WooCommerceImportListView);
